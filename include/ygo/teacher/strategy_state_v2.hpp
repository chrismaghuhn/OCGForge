...
struct EpisodeLocalStrategyStateV2 final {
    ...
    bool operator==(const EpisodeLocalStrategyStateV2& other) const noexcept {
...
struct TeacherStateDeltaV2 final {
    std::string strategy_profile_id;
    ...
    bool operator==(const TeacherStateDeltaV2& other) const noexcept {
        return strategy_profile_id == other.strategy_profile_id &&
...
struct StrategyReconciliationResultV2 final {
    EpisodeLocalStrategyStateV2 state;
    std::vector<std::string> invalidation_reason_ids;

    bool operator==(const StrategyReconciliationResultV2& other) const noexcept {
