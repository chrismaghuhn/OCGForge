...
- [ADR-0008 — Select PyTorch as the Phase-6 Task7 execution backend](ADR-0008-phase6-pytorch-primary-backend.md) — **Accepted Task6 backend decision; Task7 readiness BLOCKED**
