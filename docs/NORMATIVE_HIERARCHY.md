...
| What observation may the episodic public frame emit? | `docs/contracts/public-environment-observation-v1.md`; source state remains `docs/contracts/player-observation-v1.md` |
